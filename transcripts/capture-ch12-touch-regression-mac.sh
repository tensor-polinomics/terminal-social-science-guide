...
#
# Run on the Mac:
#   bash source-private/terminal/transcripts/capture-ch12-touch-regression-mac.sh
# then let Claude read transcripts/ch12-touch-regression-mac.txt.
#
...
# advisory lines do not appear (matching ch12-make-mac.txt).

set -uo pipefail

here="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
proj="$here/../sandbox/asset-pricing"
out="$here/ch12-touch-regression-mac.txt"
