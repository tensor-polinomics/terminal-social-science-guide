#!/usr/bin/env bash
# Capture the macOS GNU Make 3.81 TAB-trap message for Ch 12.
#
...
#   bash source-private/terminal/transcripts/capture-ch12-tabtrap-mac.sh
# then review/commit transcripts/ch12-tab-trap-mac.txt.
#
...
out="$here/ch12-tab-trap-mac.txt"
