...
# Unlike the deterministic ch12-timestamp-mac demo (touch -t on a
...
#   bash source-private/terminal/transcripts/capture-ch12-mtime-mac.sh
# then let Claude read transcripts/ch12-mtime-mac.txt (or paste
