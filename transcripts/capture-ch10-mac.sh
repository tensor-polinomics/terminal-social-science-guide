...
#   2. ch10-ps-mac.txt   - BSD `ps` exposes command-line args
...
# (source-private/terminal), the way ch05/ch08/ch09 were run:
#   bash transcripts/capture-ch10-mac.sh
# then review the two ch10-*-mac.txt files it writes and paste
...
# incl. the $TMPDIR folder-hash scrub). Ch 10 is extra
...
cout="$here/ch10-chown-mac.txt"
pout="$here/ch10-ps-mac.txt"
